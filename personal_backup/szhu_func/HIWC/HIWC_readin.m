function [ PSD, COUNTS, bin_mid, bin_diff, timehms, twc ] = HIWC_readin( institute, time, server, sep, reso)
%HIWC_READIN Read in the data of HIWC Intercomparison
% [ PSD, COUNTS, bin_mid, bin_diff ] = HIWC_readin( institute, time, server, sep, reso)
% institute 1 UI, 2 UBP, 3 EC
% time 0 whole flight 1 221300, 2 223130
