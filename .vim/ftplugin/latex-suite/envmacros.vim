...
function! Tex_SetFastEnvironmentMaps()
	if g:Tex_PromptedEnvironments != ''
"szhu28 commented the following 2 lines and added the third and fourth line
...
" szhu28: changed the \frac to \dfrac
TexLet g:Tex_Com_{'frac'} = '\dfrac{<+n+>}{<+d+>}<++>'
