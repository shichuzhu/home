...
export PATH="/home/shichu/data/usr/local/bin:$PATH"
export PATH="/home/shichu/data/usr/bin:$PATH"

alias resd="mount -o remount,exec /media/removable/sdcard"
alias sudo='sudo '

. $HOME/workspace/bin/workingWithWorkspace.sh

alias we='xiwi emacs > /dev/null 2>&1 &'
